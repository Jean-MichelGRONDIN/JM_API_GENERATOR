...
$CONTROLLER_CONTROLLER_DTO_BLOCK_PLACE$    let resDB: ($CONTROLLER_CONTROLLER_ACTION_RET_TYPE$) = await $CONTROLLER_CONTROLLER_ACTION_NAME$($CONTROLLER_CONTROLLER_DTO_VAR_NAME$);
